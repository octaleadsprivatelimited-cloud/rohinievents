...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'catering services venkateswara nagar',
    'premium catering hyderabad',
    'party catering hyderabad',
    'catering services hyderabad telangana',
    'best catering services hyderabad',
    'professional catering hyderabad',
    'catering for events hyderabad',
    'multi cuisine catering hyderabad',
    'catering services vivekananda nagar',
    'event catering company hyderabad',
    'catering services hyderabad price',
    'hyderabad catering services',
    'catering services near me hyderabad',
    'event food catering hyderabad'
  ],
  openGraph: {
    title: 'Catering Services in Venkateswara Nagar, Hyderabad | Premium Event Catering | Rohini Decorations & Events',
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="https://wa.me/919032028704?text=Hi, I'm interested in your catering services. Can you help me plan the food for my event?"
              target="_blank"
